...
export default function ProductsPage() {
  ...
  // Filters
  const [selectedStore, setSelectedStore] = useState("AB-Zone"); // Default: DDS.Piyou
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Extract available stores & categories from actual products
        const uniqueStores = [...new Set(allProducts.map(p => p.store))].filter(Boolean);
              ...
              <div className="bg-white rounded-t-3xl shadow-2xl max-h-[88vh] overflow-y-auto">
                ...
                <div className="p-6 pb-10">
                  <div className="flex items-center justify-between mb-8">
                    <h2 className="text-2xl font-medium">{t.filters?.title || "Filters"}</h2>
