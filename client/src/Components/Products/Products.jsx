                ...
                {totalPages > 1 && (
                  <div className="flex justify-center gap-3 mt-16 flex-wrap">
                    <button
                      ...
                      className="px-6 py-3 bg-white border border-stone-300 text-stone-700 rounded-xl disabled:opacity-50 hover:border-stone-400 hover: transition"
                    >
                      {t.previous || "Previous"}
                    </button>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 bg-white rounded-t-3xl max-h-[82vh] overflow-y-auto shadow-2xl border-t border-stone-200">
            <div className="p-6 pb-10">
              <div className="flex items-center justify-between mb-10">
                <h2 className="text-3xl font-semibold text-stone-900">{t.filters?.title || "Filters"}</h2>
